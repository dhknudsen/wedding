...
.controller( "AppCtrl", function AppCtrl( $scope, Alerts, Auth, $state, fbutil, resize ) {
  ...
  Alerts.add( "danger", "Oh snap! Change a few things up and try submitting again.", 2000 );
  Alerts.add( "success", "Oh snap! Change a few things up and try submitting again.", 4000 );


  $scope.closeAlert = function( index ) {
    Alerts.closeAlertIdx( index );
  };
